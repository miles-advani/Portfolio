...
### [LanguageContext](https://github.com/MilesAdvani/Portfolio/tree/main/src/store/language-context) / Context API:
...
- Utilizes the **Context Hook** to fetch `contactData`.
- Extracts the **copyright data object** from `contactData`.
